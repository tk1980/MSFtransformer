    ...
    def __init__(
        ...
        *,
        ...
        if auto_augment_policy is not None:
            ...
            elif auto_augment_policy == "three":
                transforms.append(T.RandomChoice([T.Grayscale(3),
                                              T.RandomSolarize(128.0, p=1.0),
                                              T.GaussianBlur(kernel_size=11)]))
                transforms.append(T.ColorJitter(0.3,0.3,0.3))
            else:
